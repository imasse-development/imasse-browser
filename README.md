...
In order to install the Imasse Browser app you need to clone the repository and use the expo-cli to run locally on your computer. You can also install the apk or ios.gz from the [latest release](https://github.com/imasse-dev/imasse-browser/releases/latest)
